                    ...
                    <div class="d-block d-md-flex align-items-center">
                        <div class="d-flex flex-fill">
                            ...
                            <div class="ms-2">
                                ...
                                <small><?php echo $team->user->email ?></small>
                            </div>
                        </div>
                        <div class="flex-fill text-start text-md-center my-3 my-md-0">
                        <?php if($team->permission): ?>
                            <?php foreach ($team->permission as $permission): ?>
                                <span class="badge border border-dark text-dark me-1 mb-1"><?php echo implode(': ', array_map('ucfirst', array_map('e', explode('.', $permission)))) ?></span>
                            <?php endforeach ?>
                        <?php endif ?>
                        </div>
                        <div class="flex-fill text-start text-md-end">
                            ...
                            <?php else: ?>
                                <?php if($team->status): ?>
                                <a class="me-2" href="<?php echo route('team.toggle', [$team->id]) ?>"><i data-feather="x-circle"></i> <span class="align-middle ms-1"><?php ee('Disable') ?></span></a>
                                <?php else: ?>
                                <a class="me-2" href="<?php echo route('team.toggle', [$team->id]) ?>"><i data-feather="check-circle"></i> <span class="align-middle ms-1"><?php ee('Enable') ?></span></a>
                                <?php endif ?>
                            <?php endif ?>
