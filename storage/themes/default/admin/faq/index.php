<div class="d-flex">
    <div>
        <h1 class="h3 mb-5"><?php ee('Help Center') ?></h1>
    </div>
    <div class="ms-auto">
        <a href="<?php echo route('admin.faq.new') ?>" class="btn btn-primary"><i data-feather="plus"></i> <?php ee('Add Article') ?></a>
    </div>
</div>
            ...
            <tbody>
                <?php foreach($faqs as $faq): ?>
                    <tr>
                        ...
                        <td><a href="<?php echo route('help.category', [$faq->category]) ?>" target="_blank"><?php echo ucfirst($faq->category) ?></a> (<?php echo $faq->lang ?? 'en' ?>)</td>
