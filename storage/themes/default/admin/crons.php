...
<div class="row">    
    <div class="col-md-6 h-100">
        <div class="card">
            <div class="card-body">
                <div class="form-group mb-2">
                    <label for="date" class="form-label"><?php ee('Import Links') ?></label>
                    ...
                    <p class="mt-3"><?php ee('Cron Command') ?></p>
                    <pre class="bg-dark text-white p-3 rounded my-3">wget -q -O - <?php echo route('crons.imports', [md5('imports'.AuthToken)]) ?> >/dev/null 2>&1</pre> 
