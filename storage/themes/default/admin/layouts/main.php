<!DOCTYPE html>
<html lang="<?php echo \Core\Localization::locale() ?>"<?php echo request()->cookie('darkmode') || \Helpers\App::themeConfig('homestyle', 'darkmode', true) ? 'data-scheme="dark"' : '' ?>>
    <head>
        <meta charset="utf-8">
            ...
            <nav id="sidebar" class="sidebar">
                <div class="sidebar-content <?php echo \Helpers\App::themeConfig('homestyle', 'light', 'sidebar-light', '') ?> js-simplebar">
                    <a class="sidebar-brand" href="<?php echo route('dashboard') ?>">
                        ...
                        <?php else: ?>
                            <span class="align-middle <?php echo \Helpers\App::themeConfig('homestyle', 'light', 'text-dark', 'text-white') ?>"><?php echo config('title') ?></span>
                        <?php endif ?>
