...
<div class="row">
    ...
    <div class="col-md-8">
        ...
        <div class="alert bg-warning p-3"><?php ee('We highly recommend you to save the form at each 10-15 mins because a lot can happen between start and finishing translating everything and if something happens you will have to restart again.') ?></div>
    </div>
</div>
<div class="card">
    <div class="card-body">
