<div class="d-flex">
    <div>
        <h1 class="h3 mb-5"><?php ee('Pages') ?></h1>
    </div>
    <div class="ms-auto">
        <a href="<?php echo route('admin.page.new') ?>" class="btn btn-primary"><i data-feather="plus"></i> <?php ee('Add Page') ?></a>
    </div>
</div>
                ...
                <?php foreach($pages as $page): ?>
                    <tr>
                        <td>
                            ...
                            <span class="text-muted small d-block"><?php echo route('page', [$page->seo]) ?>?lang=<?php echo $page->lang ?></span>
                        </td>
