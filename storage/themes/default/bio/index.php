            ...
            <div class="ms-auto">
                <div class="card p-2">
                    <form action="<?php echo route('bio') ?>" method="get" class="d-flex align-items-center">
                        ...
                        <div>
                            <button type="submit" class="btn btn-default bg-white"><i data-feather="search"></i></button>
                        </div>
                    </form>
                </div>
            </div>
                        ...
                        <div class="card p-3 h-100">
                            <div class="d-block d-md-flex align-items-center">
                                <div class="flex-grow-1">
                                    ...
                                    <a href="<?php echo $bio->url ?>" target="_blank" class="d-block mt-1"><strong><?php echo $bio->name ?: 'n\a' ?></strong></a>
                                    <div class="mt-1">
