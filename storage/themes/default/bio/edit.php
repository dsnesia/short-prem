    ...
    <div class="row">
        <div class="col-md-8" id="generator">
            ...
            <div class="collapse" id="appearance">
                <h4 class="fw-bold mb-3 mt-5"><?php ee('Templates') ?></h4>
				<div class="card card-body">                    
                ...
                <div class="card card-body" id="background">
                    ...
                    <div class="mb-3 mt-3">
                        <div data-toggle="buttons">
                            <a href="#singlecolor" class="btn btn text-center border bg-white rounded p-2 h-100 me-1 <?php echo $bio->data->style->mode == 'singlecolor' ? 'border-secondary' : '' ?>" data-bs-toggle="collapse" data-bs-parent="#background" data-trigger="bgtype"><?php ee('Single Color') ?></a>
                            <a href="#gradient" class="btn btn text-center border bg-white rounded p-2 h-100 me-1 <?php echo $bio->data->style->mode == 'gradient' ? 'border-secondary' : '' ?>" data-bs-toggle="collapse" data-bs-parent="#background" data-trigger="bgtype"><?php ee('Gradient Color') ?></a>
                            <a href="#image" class="btn btn text-center border bg-white rounded p-2 h-100 me-1 <?php echo $bio->data->style->mode == 'image' ? 'border-secondary' : '' ?>" data-bs-toggle="collapse" data-bs-parent="#background" data-trigger="bgtype"><?php ee('Image') ?></a>
                        </div>
                    </div>
                    <input type="hidden" name="mode" value="<?php echo $bio->data->style->mode ?? 'singlecolor' ?>">
                    <div id="singlecolor" class="collapse" <?php echo $bio->data->style->mode == 'singlecolor' ? 'style="display:block"' : '' ?>>
                        <div class="row">
                            <div class="col-md-6">
                    ...
                    <div id="gradient" class="collapse" <?php echo $bio->data->style->mode == 'gradient' ? 'style="display:block"' : '' ?>>
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group mb-3">
                    ...
                    <div id="image" class="collapse" <?php echo $bio->data->style->mode == 'image' ? 'style="display:block"' : '' ?>>
        ...
        <div class="col-md-4">
            <div id="preview">
                <div class="card border border-5 border-rounded border-dark <?php echo isset($bio->data->style->theme) ? $bio->data->style->theme : '' ?>">
                    <div class="text-center py-5" style="max-height:600px;overflow-y:scroll">
                        <?php if(isset($bio->data->avatar)): ?>
