...
class Faqs {
    ...
    public function categoriesSave(Request $request){
        ...
        $categories->{Helper::slug($request->title)} = ['title' => Helper::RequestClean($request->title), 'description' => Helper::RequestClean($request->description), 'icon' => Helper::RequestClean($request->icon), 'lang' => Helper::RequestClean($request->lang)];
    ...
    public function categoriesUpdate(Request $request, string $key){
        ...
        $categories->{$key} = ['title' => Helper::RequestClean($request->newtitle), 'description' => Helper::RequestClean($request->newdescription), 'icon' => Helper::RequestClean($request->icon), 'lang' => Helper::RequestClean($request->newlang)];
